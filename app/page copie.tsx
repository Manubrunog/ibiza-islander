            ...
            <div className="mt-10 w-full max-w-2xl border border-white/50 bg-black/20 p-4 backdrop-blur-md md:p-5">
              <div className="flex items-center gap-4 md:gap-6">
                <button
                  ...
                  onClick={() => {
                    const audio = document.getElementById("ibiza-player") as HTMLAudioElement | null;
                    if (!audio) return;
                ...
                <span className="hidden text-[10px] opacity-70 sm:block">00:00</span>
              </div>
              ...
              <audio
                ...
                className="hidden"
                preload="none"
                src="/audio/Ibiza Islander Sessions 275 By Manu.mp3"
              />
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-[1440px] md:grid-cols-2">
          <div className="border-b border-neutral-200 p-8 md:border-b-0 md:border-r md:p-10">
            <div className="mb-6 flex items-end justify-between">
              ...
              <Link href="https://www.instagram.com/ibiza_islander/" className="text-[9px] tracking-[0.18em]">FOLLOW US</Link>
            </div>
